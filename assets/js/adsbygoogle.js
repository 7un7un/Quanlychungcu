...
*/
    ...
    ha("Map", function(a) {
        ...
        e.prototype.delete = function(h) {
            h = d(this, h);
            return h.j && h.list ? (h.list.splice(h.index, 1),
    ...
    ;var xc = {}
      , yc = (xc.google_ad_client = !0,
    xc.google_ad_host = !0,
    xc.google_ad_host_channel = !0,
    xc.google_adtest = !0,
    xc.google_tag_for_child_directed_treatment = !0,
    xc.google_tag_for_under_age_of_consent = !0,
    xc.google_tag_partner = !0,
    xc.google_restrict_data_processing = !0,
    xc.google_page_url = !0,
    xc.google_adbreak_test = !0,
    xc.google_ad_frequency_hint = !0,
    xc);
    var zc = document
      , J = window;
    var Ac = {
    ...
    Cc.prototype.set = function(a, b, c) {
        ...
        this.a.cookie = a + "=" + b + c + g + h + d + (null != e ? ";samesite=" + e : "")
    }
    ;
    ...
    function Nc(a) {
        for (var b = x, c = 0; b && 40 > c++ && (!Mc(b) || !a(b)); )
            b = Oc(b)
    }
    function Pc() {
        var a = x;
    ...
    function pd(a) {
        "complete" === zc.readyState || "interactive" === zc.readyState ? (md.push(a),
        1 == md.length && (q.Promise ? q.Promise.resolve().then(nd) : window.setImmediate ? setImmediate(nd) : setTimeout(nd, 0))) : zc.addEventListener("DOMContentLoaded", a)
    }
    ;function qd(a) {
        C(this, a, null, null)
    }
    ...
    function Md() {
        if (Kd && !Mc(Ld)) {
            var a = "." + zc.domain;
            try {
                for (; 2 < a.split(".").length && !Mc(Ld); )
                    zc.domain = a = a.substr(a.indexOf(".") + 1),
                    Ld = window.parent
            } catch (b) {}
            Mc(Ld) || (Ld = window)
        }
    ...
    function Xd(a, b) {
        b = void 0 === b ? [] : b;
        var c = !1;
        x.google_logging_queue || (c = !0,
        x.google_logging_queue = []);
        x.google_logging_queue.push([a, b]);
        c && Wd() && (a = Ud("/pagead/js/logging_library.js"),
        Qc(x.document, Ic(a)))
    }
    ;function Yd(a) {
        if (!a)
        ...
        if (a instanceof Array) {
            ...
            d < c.length) {
                for (var f = [], g = 0; g < a.length; g++)
                    f.push(ge(a[g], b, c, d + 1, e));
                return f.join(c[d])
            }
        } else if ("object" == typeof a)
            return e = e || 0,
            2 > e ? encodeURIComponent(fe(a, b, c, d, e + 1)) : "...";
    ...
    m.F = function(a, b, c, d, e) {
        ...
        x.error_rep_loaded || (Qc(x.document, Ic(x.location.protocol + "//pagead2.googlesyndication.com/pagead/js/err_rep.js")),
    ...
    ;
    var ye, Be, ue = Md(), xe = new te;
    function Ce(a) {
        null != a && (ue.google_measure_js_timing = a);
        ue.google_measure_js_timing || (a = xe,
        a.a = !1,
        a.events != a.b.google_js_reporting_queue && (se() && Oa(a.events, ve),
        a.events.length = 0))
    }
    function De(a) {
        var b = J.jerExpIds;
    ...
    function Ne(a, b, c, d) {
        ...
        return 0 == e.indexOf("TagError") ? (c = b instanceof Zd ? b.error : b,
        c.pbr || (c.pbr = !0,
        Be.F(a, b, .1, d, "puberror")),
        !1) : Be.F(a, b, c, d)
    }
    ;function Oe(a) {
        var b = window;
    ...
    ;function Hg(a, b, c, d) {
        ...
        b && Zf(Yf, d)(b),
        Ig(d, e)) : (Ag(qg.h().init(H(a, ng, 2), e, c), d),
        $f(d),
        ag(d),
        bg(d),
        Ig(d, e),
    ...
    ;function Jg(a) {
        ...
        if (b.plle)
            ...
            wb("") && d.push("");
            a = Pd(a) || a;
            Qd(a.location, "google_mc_lab") && d.push("242104166")
        }
    }
    function Je(a) {
        var b = dg.h().a();
    ...
    function Gh(a, b, c, d) {
        var e = Fh(b, c, a, .3, d);
        !0 !== e ? a = e : "true" == d.google_full_width_responsive || Dh(c, b) ? Hh(b) ? a = !0 : (b = M(b),
        a = b - a,
    ...
    ;function ii(a) {
        ...
        if (D(a, 1) || a.getId() || 0 < D(a, 4).length) {
            ...
            b = b ? new ci(b,D(a, 2),D(a, 5),ji(D(a, 6))) : null;
        return b
    }
    var ki = {
        1: 1,
    ...
    function ri(a, b) {
        ...
        b.forEach(function(e) {
            if (G(e, Pg, 1)) {
                ...
                G(e, Qg, 2) ? ti(a, G(e, Qg, 2), c) : G(e, Rg, 3) && ui(a, G(e, Rg, 3), d)
        });
        return new qi(c,d)
    }
    function ti(a, b, c) {
    ...
    function Ei(a, b) {
        ...
        var f;
        if (f = !e && G(a.b, dh, 15) && lc(G(a.b, dh, 15), 12))
            a: {
                f = wh(a.a);
                f = null !== f ? H(f, th, 5) : null;
                var g = wh(a.a);
                ...
                if (null == f)
                    ...
                    for (var l = [], n = 0; n < f.length; n++) {
                        ...
                        v = c[p];
                        var r = G(f[n], sh, 2);
                        null != r && null != jc(r, 1) && null != jc(r, 2) && null != jc(r, 3) && (r = new oh(jc(r, 1),jc(r, 2),jc(r, 3)),
                        ni(l, k, r) && (p = Fi(a, v, p, b, d, h),
                        null != p && null != p.P && (p = p.P.getBoundingClientRect(),
                        l.push(p))))
                    }
    ...
    function Fi(a, b, c, d, e, f) {
        if (!G(b, Tg, 4) || !f.contains(D(G(b, Tg, 4), 1)) || 1 !== D(b, 8) || !zi(b, e))
            return null;
        a.c++;
        if (b = Gi(a, b, d, e))
            d = Di(a),
    ...
    function Gi(a, b, c, d) {
        ...
        a: {
            try {
                ...
                (t = f.da) && t.parentNode && (F = t.parentNode,
                F.removeChild(t),
                Vh(F) && (F.style.display = F.getAttribute("data-init-display") || "none"));
                t = !1;
                break a
            }
            t = !0
            ...
            if (b instanceof mb)
                ...
                if (b instanceof Fb)
                    ...
                    if (b instanceof Fb)
                        ...
                        Ib.test(b) || (b = "about:invalid#zClosurez"),
                        h = new Fb(b,Gb);
                    g = Hb(h)
                }
                f = g
    ...
    function Yi(a) {
        if (x.google_apltlad || Od(x) != x || !a.google_ad_client)
            return null;
        var b = Xi(a);
        x.google_apltlad = !0;
    ...
    function ij(a, b, c) {
        ...
        b = Md();
        b = Pd(b) || b;
        Qd(b.location, "google_responsive_slot_debug") && (c.ds = "outline:thick dashed " + (d && e ? !0 !== a.b || !0 !== a.f ? "#ffa500" : "#0f0" : "#f00") + " !important;");
...
*/
    var jj = {}
      , kj = (jj.image_stacked = 1 / 1.91,
    jj.image_sidebyside = 1 / 3.82,
    jj.mobile_banner_image_sidebyside = 1 / 3.82,
    jj.pub_control_image_stacked = 1 / 1.91,
    jj.pub_control_image_sidebyside = 1 / 3.82,
    jj.pub_control_image_card_stacked = 1 / 1.91,
    jj.pub_control_image_card_sidebyside = 1 / 3.74,
    jj.pub_control_text = 0,
    jj.pub_control_text_card = 0,
    jj)
      , lj = {}
      , mj = (lj.image_stacked = 80,
    lj.image_sidebyside = 0,
    lj.mobile_banner_image_sidebyside = 0,
    lj.pub_control_image_stacked = 80,
    lj.pub_control_image_sidebyside = 0,
    lj.pub_control_image_card_stacked = 85,
    lj.pub_control_image_card_sidebyside = 0,
    lj.pub_control_text = 80,
    lj.pub_control_text_card = 80,
    lj)
      , nj = {}
      , oj = (nj.pub_control_image_stacked = 100,
    nj.pub_control_image_sidebyside = 200,
    nj.pub_control_image_card_stacked = 150,
    nj.pub_control_image_card_sidebyside = 250,
    nj.pub_control_text = 100,
    nj.pub_control_text_card = 150,
    nj);
    function pj(a) {
        var b = 0;
        a.B && b++;
    ...
    function tj(a, b) {
        ...
        if ("pedestal" == b.google_content_recommendation_ui_type)
            return new hj(9,new sj(a,Math.floor(a * b.google_phwr)));
        var c = Jc();
        468 > a ? c ? (c = a - 8 - 8,
        c = Math.floor(c / 1.91 + 70) + Math.floor(11 * (c * kj.mobile_banner_image_sidebyside + mj.mobile_banner_image_sidebyside) + 96),
        a = {
            N: a,
            L: c,
            u: 1,
    ...
    function uj(a, b) {
        if (0 >= a)
            throw new L("Invalid responsive width from Matched Content slot " + b.google_ad_slot + ": " + a + ". Please ensure to put this Matched Content slot into a non-zero width div container.");
    }
    function vj(a, b) {
    ...
    function Aj(a, b, c, d, e) {
        ...
        if ("in-article" == f && "false" != e.google_full_width_responsive) {
            ...
            if (!0 !== g)
                ...
                c.parentElement && (Kh(b, c),
                Mh(b, c),
                a = g)
        }
        if (250 > a)
            throw new L("Fluid responsive ads must be at least 250px wide: availableWidth=" + a);
        a = Math.min(1200, Math.floor(a));
        if (d && "in-article" != f) {
            f = Math.ceil(d);
            if (50 > f)
                throw new L("Fluid responsive ads must be at least 50px tall: height=" + f);
        ...
        if ("in-article" != f && (d = e.google_ad_layout_key)) {
            ...
            if (d = (c = f.match(/([+-][0-9a-z]+)/g)) && c.length) {
                ...
                b = null;
            if (!b)
                throw new L("Invalid data-ad-layout-key value: " + f);
            f = (a + -725) / 1E3;
            c = 0;
            d = 1;
            e = b.length;
            ...
            if (isNaN(f))
                throw new L("Invalid height: height=" + f);
            if (50 > f)
                throw new L("Fluid responsive ads must be at least 50px tall: height=" + f);
            if (1200 < f)
                throw new L("Fluid responsive ads must be at most 1200px tall: height=" + f);
            return new hj(11,new S(a,f))
        }
        d = yj[f];
        if (!d)
            throw new L("Invalid data-ad-layout value: " + f);
        c = Ph(c, b);
        b = M(b);
    ...
    function Ej(a, b, c, d, e) {
        "false" == e.google_full_width_responsive ? c = {
            l: a,
            m: 1
        } : "autorelaxed" == b && e.google_full_width_responsive || Fj(b) || e.google_ad_resize ? (488 > M(c) && (Hh(c) || P(1002)) && Kh(c, d),
        b = Gh(a, c, d, e),
        c = !0 !== b ? {
            l: a,
            m: b
    ...
    function Gj(a, b, c, d, e) {
        ...
        var p = n.G
          ...
          , r = n.ba;
        n = n.qa;
        var A = Ij(b, r), t, F = (t = T(d, c, "marginLeft", K)) ? t + "px" : "", Da = (t = T(d, c, "marginRight", K)) ? t + "px" : "";
        t = T(d, c, "zIndex") || "";
    ...
    function Hj(a, b, c, d, e, f) {
        ...
        if (!v)
            throw new L("No slot size for availableWidth=" + a);
        p = Ke(248, function() {
            var r;
            a: if (f) {
                ...
                var A = Te(c).clientHeight
                  ...
                  , F = c.google_lpabyc
                  , Da = Sh(d, c);
                Da && 2 < Da && !c.google_bfabyc && (!F || t - F > A) && (A = .9 * Te(c).clientHeight,
                t = Math.min(A, Kj(c, d, e)),
                A && t == A && (t = c.google_pbfabyc,
                r = !t,
                t || (c.google_pbfabyc = Bh(d, c) + A)));
                A = a / 1.2;
                if (Hh(c))
                    t = A;
                else if (t = Math.min(A, Kj(c, d, e)),
                t < .5 * A || 100 > t)
                    t = A;
    ...
    function Pj(a, b, c) {
        ...
        var f = Cj(Oj, Nh(a));
        if (!f)
            throw new L("No link unit size for width=" + a + "px");
        a = Math.min(a, 1200);
        f = f.height();
        b = Math.max(f, b);
    ...
    ;function Rj(a, b, c, d, e) {
        var f;
        (f = M(b)) ? 488 > M(b) ? b.innerHeight >= b.innerWidth ? (e.google_full_width_responsive_allowed = !0,
        Mh(b, c),
        f = {
            l: f,
            m: !0
        ...
        g = g.m;
        if (!0 !== g || a == f)
            return new hj(12,new S(a,d),null,null,!0,g,100);
        a = Hj(f, "auto", b, c, e, !0);
    ...
    ;function Sj(a, b) {
        ...
        if ("fluid" == c) {
            if (c = "in-article" === b.google_ad_layout)
                c = P(208) || P(227) || a.location && ("#hffwroe2etop" == a.location.hash || "#hffwroe2etoq" == a.location.hash);
            return c ? (Tj(b),
            1) : 8
        }
    ...
    function Uj(a, b, c, d, e) {
        ...
        (P(310) || d.location && "#ooimne2e" == d.location.hash) && 4 === a && (c.google_ad_format = "auto",
        a = 1);
    ...
    m = X.prototype;
    m.Fa = function(a, b) {
        0 != this.a || 0 != this.f.length || b && b != window ? this.na(a, b) : (this.a = 2,
        this.wa(new Xj(a,window)))
    }
    ;
    m.na = function(a, b) {
    ...
    ;var fk = {}
      , gk = (fk.google_ad_modifications = !0,
    fk.google_analytics_domain_name = !0,
    fk.google_analytics_uacct = !0,
    fk.google_pause_ad_requests = !0,
    fk);
    function hk(a, b, c) {
    ...
    function jk(a, b) {
        if (hk("__gads", b, a.a.document))
            return !0;
        var c = a.a.document;
        c = void 0 === c ? document : c;
        kc(b, 5) && (new Cc(c)).set("GoogleAdServingTest", "Good", void 0);
        if (c = "Good" === hk("GoogleAdServingTest", b, a.a.document))
            a = a.a.document,
    ...
    function rk() {
        x.processGoogleToken = x.processGoogleToken || function(a, b) {
            ...
            if (k || d || l)
                ...
                e = d + 1E3 * e,
                f = d + 1E3 * f,
                1E-5 > Math.random() && yd(x, "https://pagead2.googlesyndication.com/pagead/gen_204?id=imerr&err=" + b),
                h[5] = b,
                h[1] = a,
                h[2] = e,
                h[3] = f,
    ...
    function tk(a) {
        ...
        a = void 0 === a ? "" : a;
        sk(b);
        b.google_sa_queue || (b.google_sa_queue = [],
        b.google_sl_win = b,
        ...
        ,
        a = vk(b, a),
        Qc(b.document, Ic(a), P(356)).id = "google_shimpl")
    }
            ...
            try {
                if (Mc(a.document.getElementById(b).contentWindow)) {
                    ...
                    for (var k = 0; k < f.length; k++) {
                        var l = f.charAt(k), n = l.charCodeAt(0), p = k + 1, v;
                        if (!(v = Xb[l])) {
                            if (31 < n && 127 > n)
                                var r = l;
                            else {
                ...
                h = bi().google_jobrunner,
                ak(h) && h.rl()
            }
            e && (e = bj("google_async_rrc", c),
            (new aj(a)).set(b, zk(a, b, e, !1)))
        }
    }
    function Ak(a) {
        if (!ej)
        ...
        if (!ej) {
            ...
            c.id = "google_esf";
            c.name = "google_esf";
            h = Td("googleads.g.doubleclick.net", ["/pagead/html/", sd(), "/r20190131/zrt_lookup.html#", encodeURIComponent("")].join(""));
            c.src = h;
    ...
    function Bk(a, b, c) {
        Ck(a, b, c, function(d, e, f) {
            ...
            if (!f.google_enable_single_iframe) {
                l = ["<iframe"];
                for (p in e)
                    e.hasOwnProperty(p) && ("onload" === p && P(381) ? (n = e.id,
                    n = "<script nonce='" + va() + "'>" + lb(kb(new eb(fb,"function(iframeId, globalVarName){document.getElementById(iframeId).addEventListener('onload', function() {var i=this.id,s=window[globalVarName],H=s&&s.handlers,h=H&&H[i],w=this.contentWindow,d;try{d=w.document}catch(e){}if(h&&d&&(!d.body||!d.body.firstChild)){if(h.call){setTimeout(h,0)}else if(h.match){try{h=s.upd(h,i)}catch(e){}w.location.replace(h)}}});}"), n, "google_iframe_oncopy")).toString() + "\x3c/script>") : l.push(p + "=" + e[p]));
            ...
            p = ['<ins id="' + (p + '_expand"'), ' style="display:inline-table;' + g + (void 0 === k ? "" : k) + '"', v ? ' data-ad-slot="' + v + '">' : ">", '<ins id="' + (p + '_anchor" style="display:block;') + g + '">', l, "</ins></ins>"].join("") + n;
            16 == f.google_reactive_ad_format ? (f = d.createElement("div"),
            d = Gc(p),
            Vb(f, d),
            c.appendChild(f.firstChild)) : (f = Gc(p),
            Vb(c, f));
            return e.id
        })
    }
    ...
    function Ck(a, b, c, d) {
        ...
        if (b.google_enable_single_iframe) {
            ...
            b = ["<!doctype html><html><body>", "<script nonce='" + va() + "'>", lb(kb(new eb(fb,"function(singleLoadWindow,iframeStartTime,asyncIframeId,iframeId){window[singleLoadWindow]=window.parent;window[iframeStartTime]=new Date().getTime();window[asyncIframeId]=iframeId;}"), "google_sl_win", "google_iframe_start_time", "google_async_iframe_id", d)).toString(), "\x3c/script>", Dk(d), "</body></html>"].join(""),
            wk(a, zk(a, d, b, !0), a.document.getElementById(d) ? ck : dk)
    }
    function Ek(a, b, c) {
                ...
                if (P(225)) {
                    ...
                    2 === f.b && (b._gfp_s_ = Le(629, function(g) {
                        ...
                        if (g = g._cookies_) {
                            ...
                            kc(e, 5) && .01 > f.a.Math.random() && (h = hk("__gads", e, f.a.document),
                            Ad({
                                domain: D(g, 4),
        ...
        for (var c = a.length, d = 0; d < c; d++) {
            ...
            if (/data-/.test(e.name)) {
                ...
                if (!b.hasOwnProperty(f)) {
                    e = e.value;
                    var g = {};
                    g = (g.google_reactive_ad_format = rd,
                    g.google_allow_expandable_ads = ed,
                    g);
    ...
    function Kk(a, b, c) {
            ...
            if (0 < e && d > e) {
                ...
                if (d) {
                    ...
                    if (h)
                        ...
                        throw new L("No slot size for availableWidth=" + e);
                }
        ...
        if (g = 0 !== f)
            b: if (!(488 > M(c) || P(216)) || b.google_reactive_ad_format || Sj(c, b) || Ah(a, b))
                g = !1;
            else {
        ...
        if (e = Sj(c, b))
            ...
            if (Ah(a, b)) {
                ...
                zh(a.style, b);
            c.location && "#gfwmrp" == c.location.hash || 12 == b.google_responsive_auto_format && "true" == b.google_full_width_responsive ? Uj(10, a, b, c, !1) : .01 > Math.random() && 12 == b.google_responsive_auto_format && (a = Gh(a.offsetWidth || parseInt(a.style.width, 10) || b.google_ad_width, c, a, b),
            !0 !== a ? (b.efwr = !1,
    ...
    function Yk() {
        ...
        if (P(203) && !window.google_plmetrics && window.PerformanceObserver) {
            ...
            for (var b = w(["layout-shift", "largest-contentful-paint", "first-input", "longtask"]), c = b.next(); !c.done; c = b.next())
                c = c.value,
                Zk(a).observe({
                    type: c,
                    buffered: !P(240)
                    ...
                    if (!c) {
                        try {
                            if ("undefined" !== typeof googletag && googletag.pubads) {
                                ...
                                Uk.clear();
                                for (var f = w(e.getSlots()), g = f.next(); !g.done; g = f.next())
                                    Uk.add(g.value.getSlotId().getDomId())
                            }
                        } catch (n) {}
                        c = !0
                    }
    ...
    Xk.prototype.a = function() {
        ...
        if (a) {
            ...
            a += Tk("nls", this.o),
            window.LayoutShiftAttribution && (a += "&cas=" + this.b.toFixed(3),
            a += Tk("nas", this.W)));
            window.LargestContentfulPaint && (a += Tk("lcp", this.O));
            window.PerformanceEventTiming && this.K && (a += Tk("fid", this.J));
            window.PerformanceLongTaskTiming && (a += Tk("cbt", this.c),
            a += Tk("mbt", this.g),
            a += Tk("nlt", this.s));
            for (var b = 0, c = w(document.getElementsByTagName("iframe")), d = c.next(); !d.done; d = c.next())
                Vk(d.value) && b++;
            a += Tk("nif", b);
            a += Tk("ifi", Id(window));
            b = dg.h().a();
    ...
    qa(al, vd);
    function bl(a) {
        !document.hasTrustToken || 3 <= a.a || (a.a = 3,
        Oa(a.f, function(b) {
            window.fetch(b + "/tt/r", {
                keepalive: !0,
                redirect: "follow",
    ...
    function ll(a, b, c) {
        ...
        f = I(c);
        wc(f.ad_whitelist || [], g, h) ? g = null : (h = f.space_collapsing || "none",
        g = (g = wc(f.ad_blacklist || [], g)) ? {
            ka: !0,
        ...
        if (g && g.ka && "on" != b.google_adtest && !e && (e = Sh(a, c),
        !g.ca || g.ca && (e || 0) >= g.ca))
            ...
            "slot" == g.Aa && (null !== dd(a.getAttribute("width")) && a.setAttribute("width", 0),
            null !== dd(a.getAttribute("height")) && a.setAttribute("height", 0),
            a.style.width = "0px",
            a.style.height = "0px"),
            !0;
        if ((e = Rc(a, c)) && "none" == e.display && !("on" == b.google_adtest || 0 < b.google_reactive_ad_format || d))
        ...
        return 1 !== b.google_reactive_ad_format && 8 !== b.google_reactive_ad_format || !a ? !1 : (x.console && x.console.warn("Adsbygoogle tag with data-reactive-ad-format=" + b.google_reactive_ad_format + " is deprecated. Check out page-level ads at https://www.google.com/adsense"),
        !0)
    }
    function ml(a) {
    ...
    function sl(a) {
        ...
        var d = P(1001)
          , e = Pd(c);
        if (!e && !d)
            throw new L("Page-level tag does not work inside iframes.");
    ...
    function ul(a) {
        ...
        Wc(a, function(b, c) {
            ...
            x.console.warn("AdSense head tag doesn't support " + b + " attribute."))
        })
    }
    function vl() {
        var a = J
        ...
        if (b) {
            ...
            if (c.head_tag_slot_vars)
                throw new L("Only one AdSense head tag supported per page. The second tag is ignored.");
            var d = {};
            Ik(b, d);
            ul(d);
            var e = bb(d);
            ...
            b = {};
            b = (b.google_ad_client = d.google_ad_client,
    ...
    function tl(a, b) {
        if (null == a)
            throw new L("push() called with no parameters.");
        if ("object" !== typeof a || null == a || "string" !== typeof a.type && "string" !== typeof a.sound) {
            ...
            "js" === b.google_ad_output)
                ...
                if (a.hasAttribute("data-require-head") && !I(x).head_tag_slot_vars)
                    throw new L("AdSense head tag is missing. AdSense body tags don't work without the head tag. You can copy the head tag from your account on https://adsense.com.");
                if (!b.google_ad_client)
                    throw new L("Ad client is missing from the slot.");
                b.google_apsail = Ye(b.google_ad_client);
                var d = (c = 0 === (I(J).first_tag_on_page || 0) && Yi(b)) && Zi(c);
                c && !d && (xl(c),
                I(J).skip_next_reactive_tag = !0);
                0 === (I(J).first_tag_on_page || 0) && (I(J).first_tag_on_page = 2);
                P(371) || ("_gfp_p_"in J || (J._gfp_p_ = !1),
                Hk(b.google_ad_client));
            ...
            null != gl && null == a.sound && gl.handleAdBreak(a).catch(function(e) {
    ...
    function xl(a, b) {
        if (I(J).skip_next_reactive_tag)
            I(J).skip_next_reactive_tag = !1;
        else {
            0 === (I(J).first_tag_on_page || 0) && (I(J).first_tag_on_page = 1);
            b && a.tag_partner && (uc(x, a.tag_partner),
            uc(b, a.tag_partner));
            a: if (!I(J).ama_ran_on_page) {
                ...
                if (b = d)
                    ...
                    !c || D(c, 1) <= Date.now())
                        ...
                        if (Zi(a) && (c = eh(H(b, Zg, 7)),
                        !c || !kc(c, 8)))
                            break a;
                        I(J).ama_ran_on_page = !0;
                        (d = G(b, bh, 13)) && 1 === D(d, 1) && (c = 0,
                        (d = G(d, ch, 6)) && D(d, 3) && (c = D(d, 3) || 0),
                        d = I(x),
                        ...
                        try {
                            ...
                            if (f) {
                                if (D(e, 4)) {
                                    f = {};
                                    var k = new gh(null,(f.google_package = D(e, 4),
                                    f));
                                    d = hh(d, k)
                                }
    ...
    function yl(a) {
        if (a) {
            ...
            !a))
                throw new L("'element' has already been filled.");
            if (!("innerHTML"in a))
                throw new L("'element' is not a good DOM element.");
        } else if (a = ml(),
        !a)
            throw new L("All ins elements in the DOM with class=adsbygoogle already have ads in them.");
        return a
    }
    function Al() {
        var a = J
        ...
        var e;
        (e = "function" === typeof c.b.__uspapi) || (c.a ? c = c.a : (c.a = fd(c.b, "__uspapiLocator"),
        c = c.a),
        e = null != c);
        Me("cmpMet", {
            tcfv1: a,
    ...
    function Bl() {
        ...
        if (!z("Trident") && !z("MSIE") || 0 <= Db(Ob(), 11)) {
            ...
            Ce(P(84));
            P(345) || (pk(),
            mk(".google.com.vn") && (Z[1] = ".google.com.vn"),
            rk());
            ...
            if (a = Pd(x))
                a = Se(a),
                a.tagSpecificState[1] || (a.tagSpecificState[1] = new Qi);
            vl();
            ...
            if (!a || !a.loaded) {
                ...
                if (a)
                    for (var c = w(["requestNonPersonalizedAds", "pauseAdRequests", "cookieOptions"]), d = c.next(); !d.done; d = c.next())
                        d = d.value,
                        void 0 !== a[d] && (b[d] = a[d]);
    ...
    function Cl(a) {
        if (P(365)) {
            ...
            if ((a = Pc()) && a.frames && !a.frames.GoogleSetNPA)
                try {
                    b = a.document;
                    var c = new Fc(b)
            ...
            (b = Pc().document.getElementById("GoogleSetNPA")) && b.parentNode && b.parentNode.removeChild(b)
    }
    function Dl(a) {
        Number(a) ? I(J).pause_ad_requests = !0 : (I(J).pause_ad_requests = !1,
        a = function() {
    ...
    function El(a) {
        ...
        J._gfp_a_ = a;
        "_gfp_p_"in J && !P(371) && (a = J.google_sv_map,
        Hk(a[Xc(a)].google_ad_client))
    }
    function Fl(a) {
